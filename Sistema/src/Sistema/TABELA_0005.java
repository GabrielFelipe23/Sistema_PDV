 ...
 */
public class TABELA_0005 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tabela_DadosLocal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RAZAO SOCIAL", "CNPJ", "CPF", "CIDADE", "TELEFONE"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TABELA_0005.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TABELA_0005().setVisible(true);
            }
        });
    }
