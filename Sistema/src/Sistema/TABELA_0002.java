 ...
 */
public class TABELA_0002 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (Tabela_DadosLocal.getColumnModel().getColumnCount() > 0) {
            Tabela_DadosLocal.getColumnModel().getColumn(0).setPreferredWidth(350);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TABELA_0002.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TABELA_0002().setVisible(true);
            }
        });
    }
